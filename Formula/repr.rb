class Repr < Formula
  ...
  on_macos do
    if Hardware::CPU.arm?
      url "https://github.com/repr-app/cli/releases/download/v0.2.9/repr-macos.tar.gz"
  ...
  on_linux do
    url "https://github.com/repr-app/cli/releases/download/v0.2.9/repr-linux.tar.gz"
