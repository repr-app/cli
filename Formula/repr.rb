class Repr < Formula
  ...
  on_macos do
    if Hardware::CPU.arm?
      url "https://github.com/repr-app/cli/releases/download/v0.2.16/repr-macos.tar.gz"
  ...
  on_linux do
    url "https://github.com/repr-app/cli/releases/download/v0.2.16/repr-linux.tar.gz"
    sha256 "0019dfc4b32d63c1392aa264aed2253c1e0c2fb09216f8e2cc269bbfb8bb49b5"
  end
